...
public:
	...
	static inline uint32_t cr0() { uint32_t v; asm volatile("mov %%cr0, %0" : "=r"(v)); return v; }
	static inline uint32_t cr2() { uint32_t v; asm volatile("mov %%cr2, %0" : "=r"(v)); return v; }
	static inline uint32_t cr3() { uint32_t v; asm volatile("mov %%cr3, %0" : "=r"(v)); return v; }
	static inline uint32_t cr4() { uint32_t v; asm volatile("mov %%cr4, %0" : "=r"(v)); return v; }
	static inline void cr0(uint32_t v) { asm volatile("mov %0, %%cr0" :: "r"(v)); }
	static inline void cr3(uint32_t v) { asm volatile("mov %0, %%cr3" :: "r"(v)); }
	static inline void cr4(uint32_t v) { asm volatile("mov %0, %%cr4" :: "r"(v)); }
